...
setup(
    ...
    packages=find_packages(include=['sleeper_analyzer', 'sleeper_analyzer.*', 'sleeper_cli', 'sleeper_cli.*', 'sleeper_gui', 'sleeper_gui.*']),
    ...
    entry_points={
        'console_scripts': [
            ...
            'sleeper-gui = sleeper_gui.__main__:console_entry',
        ]
    }
)
